...
if __name__ == "__main__":
    ...
    # Add arguments
    parser.add_argument("-s", "--take_screenshots", type=bool, default=False, help="Take screenshots after every operation performed (default: False)")
    parser.add_argument("-wait", "--wait_time_non_headless", type=int, default=5, help="Time to wait between test tasks when running in non-headless mode (default: 10 seconds)")
    parser.add_argument("-min", "--min_task_index", type=int, default=0, help="Minimum task index to start tests from (default: 0)")
