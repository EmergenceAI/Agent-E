...
"final_response": This is the final reply that will be returned to the user. This should be short but complete. If there are multiple answers, provide the single best suited answer. This attribute only needs to be present when terminate is true.
