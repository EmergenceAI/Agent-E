...
"final_response": This is the final answer that will be returned to the user. This should be a short and precise answers. Unless otherwise specified, if there are multiple answers, reply with the best among them. This attribute only needs to be present when terminate is true.
