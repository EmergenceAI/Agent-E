...
"final_response": This is the final answer that will be returned to the user. Unless explicitly asked, you will only provide the top answer and not list every option. This attribute only needs to be present when terminate is true.
