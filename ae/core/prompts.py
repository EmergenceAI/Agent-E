...
"final_response": This is the final answer string that will be returned to the user. This needs to very very very detailed. This attribute only needs to be present when terminate is true.
