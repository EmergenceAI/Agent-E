...
"final_response": This is the final answer that will be returned to the user. When the task is to search for a product or when multiple answers exists, you must provide the single most suited answer as reply. This attribute only needs to be present when terminate is true.
