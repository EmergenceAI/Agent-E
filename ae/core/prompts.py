...
8. If the task involves research about a company. Some of the dimensions to consider are: company overview, founding team and background, products, latest news, history, financials, news, customer reviews, employee reviews and competitors. You will strive to gather as much information as possible about the company.
