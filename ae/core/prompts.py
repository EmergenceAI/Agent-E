...
"final_response": This is the final answer that will be returned to the user. Unless explicitly stated, when there are multiple answers, you must provide the single top answer. This attribute only needs to be present when terminate is true.
