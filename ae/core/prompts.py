...
"final_response": This is the final answer that will be returned to the user. Unless explicitly stated, you will provide the single best suited result (e.g. a single product) in the response. This attribute only needs to be present when terminate is true.
