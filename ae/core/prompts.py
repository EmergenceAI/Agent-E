...
"final_response": This is the final answer that will be returned to the user. If the task asks for a single product or answer, you will not list more than one options. This attribute only needs to be present when terminate is true.
